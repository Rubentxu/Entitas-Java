...
public class ComponentExtensionGeneratorTest {
    ...
    public void generateComponentInfos() {
        ...
        componentInfos.add(new ComponentInfo("com.ilargia.games.logicbrick.component.Position", "Position", memberInfos, poolNames,
                false, "", true, true, false, false, null, null, null,"", null));
        componentInfos.add(new ComponentInfo("com.ilargia.games.logicbrick.component.Movable", "Movable", memberInfos2, poolNames,
