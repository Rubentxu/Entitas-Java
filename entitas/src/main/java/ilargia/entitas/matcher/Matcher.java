package ilargia.entitas.matcher;

import ilargia.entitas.api.entitas.IEntity;
import ilargia.entitas.api.matcher.IAllOfMatcher;
import ilargia.entitas.api.matcher.IAnyOfMatcher;
import ilargia.entitas.api.matcher.IMatcher;
import ilargia.entitas.api.matcher.INoneOfMatcher;
import ilargia.entitas.caching.EntitasCache;
import ilargia.entitas.exceptions.MatcherException;
...
public class Matcher<TEntity extends IEntity> implements IAllOfMatcher<TEntity>, IAnyOfMatcher<TEntity>, INoneOfMatcher<TEntity> {
    ...
    public IAnyOfMatcher<TEntity> anyOf(IMatcher<TEntity>... matchers) {
        return this.anyOf(mergeIndices(matchers));
    }
