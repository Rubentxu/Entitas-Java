...
public class ReactiveEntityIndex<TEntity extends Entity, TKey> extends AbstractReactiveEntityIndex<TEntity, TKey> {

    private Map<TKey, Set<TEntity>> _index; // Object2ObjectArrayMap<ObjectOpenHashSet

    public ReactiveEntityIndex( Func<TEntity, IComponent, TKey> key, IGroup<TEntity> group) {
        super(key, group);
        _index = EntitasCollections.createMap(Object.class, Entity.class); //Object2ObjectArrayMap
        activate();
    }

    public ReactiveEntityIndex(IGroup<TEntity> group, Func<TEntity, IComponent, TKey[]> keys)  {
        super(group, keys);
        _index = EntitasCollections.createMap(Object.class, Entity.class); //Object2ObjectArrayMap
        activate();
    }
