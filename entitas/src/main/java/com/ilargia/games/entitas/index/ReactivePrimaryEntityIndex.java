...
public class ReactivePrimaryEntityIndex<TEntity extends Entity, TKey> extends AbstractReactiveEntityIndex<TEntity, TKey> {

    private Map<TKey, TEntity> _index; //Object2ObjectArrayMap

    public ReactivePrimaryEntityIndex(Func<TEntity, IComponent, TKey> key, IGroup group) {
        super(key, group);
        _index = EntitasCollections.createMap(Object.class, Object.class);
        activate();
    }

    public ReactivePrimaryEntityIndex(IGroup<TEntity> group, Func<TEntity, IComponent, TKey[]> keys) {
        super(group, keys);
        _index = EntitasCollections.createMap(Object.class, Object.class);
        activate();
    }
