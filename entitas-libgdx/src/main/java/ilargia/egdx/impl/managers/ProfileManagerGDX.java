...
import ilargia.egdx.api.managers.ProfileManager;

public class ProfileManagerGDX<P> implements ProfileManager<P> {

    private PreferencesManagerGDX preferencesManager;
    private P profile;

    public ProfileManagerGDX(P profile, PreferencesManagerGDX preferencesManager) {
