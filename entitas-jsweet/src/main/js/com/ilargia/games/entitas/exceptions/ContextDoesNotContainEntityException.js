        ...
        (function (games) {
            ...
            (function (entitas) {
                ...
                (function (exceptions) {
                    ...
                    var ContextDoesNotContainEntityException = (function (_super) {
                        __extends(ContextDoesNotContainEntityException, _super);
                        function ContextDoesNotContainEntityException(message, hint) {
                            _super.call(this, message + "\nSplashPool does not contain entity!", hint);
                        }
                        return ContextDoesNotContainEntityException;
                    }(EntitasException));
                    exceptions.ContextDoesNotContainEntityException = ContextDoesNotContainEntityException;
