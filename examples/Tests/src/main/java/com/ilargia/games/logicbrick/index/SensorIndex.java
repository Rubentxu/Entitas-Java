...
public class SensorIndex {
    ...
    public static void createSensorsIndices(SensorContext context) {
    ...
    public static void addSensor(SensorContext context, Integer index, SensorEntity entity) {
    ...
    public static Set<SensorEntity> getSensors(SensorContext context, GameEntity entity) {
        EntityIndex<SensorEntity, Integer> eIndex = (EntityIndex<SensorEntity, Integer>) context.getEntityIndex(SensorKey);
